...
public class AuthService {
    ...
    private final com.mini.notification_service.InternalNotificationService notificationService;
    ...
    public AuthService(
            ...
            com.mini.notification_service.InternalNotificationService notificationService
    ) {
    ...
    public void forgotPassword(String email) {
        ...
        // Send OTP via internal service
        notificationService.sendOtpNotification(email, otp);
        System.out.println("OTP sent internally: " + otp);
    }
