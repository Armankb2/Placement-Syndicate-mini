    ...
    <div className="container animate-up">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Manage the interview experiences you have shared with the community.</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="empty-state glass">
          <span className="icon">SH</span>
          <p>You have not shared any experiences yet.</p>
          ...
          {experiences.map((exp) => (
            <div key={exp.id} className="experience-card glass glass-hover">
              ...
              <div className="card-body">
                <p className="meta-info">Year {exp.year} / Shared {new Date(exp.createdDate).toLocaleDateString()}</p>
